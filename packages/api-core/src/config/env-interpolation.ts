 ...
 * ```
 */
export function interpolateString(value: string, options: InterpolationOptions = {}): string {
 ...
 * ```
 */
export function interpolateValue<T>(value: T, options: InterpolationOptions = {}): T {
