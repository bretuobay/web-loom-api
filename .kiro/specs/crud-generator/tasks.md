...
- [ ] 1. Create `@web-loom/api-generator-crud` package
...
- [ ] 2. Implement primary key resolver
...
- [ ] 3. Implement auth middleware resolver
...
- [ ] 6. Implement the Create handler
...
- [ ] 7. Implement the Replace handler
...
- [ ] 9. Implement the Delete handler
...
- [ ] 10. Apply soft delete filter to List and Read
...
- [ ] 11. Implement `generateCrudRouter()`
...
- [ ] 12. Wire CRUD generator into `createApp()`
